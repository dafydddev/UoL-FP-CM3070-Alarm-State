...
namespace Guards
{
    ...
    public class GuardVisionField : MonoBehaviour
    {
        ...
        private Surface _calm;
        private Surface _alert;
        private Vector2 _cellSize = Vector2.one;

        private void Awake()
        {
            _calm = new Surface(transform, "CalmVision", sortingOrder);
            _alert = new Surface(transform, "AlertVision", sortingOrder);
        }
        ...
        private sealed class Surface
        {
            ...
            public Surface(Transform parent, string name, int sortingOrder)
            {
            ...
            public void Rebuild(HashSet<Vector3> centers, Vector2 half, Color color)
            {
